...
function Nav() {
  ...
  return (
    <nav className='overflow-x-scroll flex sm:flex-col items-center justify-evenly bg-stone-900 fixed bottom-0 sm:top-0 left-0 w-full sm:w-auto sm:h-full z-20 p-4'>
      ...
      <a href="#about" className='flex flex-col xl:flex-row items-center w-full text-slate-100 hover:bg-red-500 transition-colors text-[24px] px-[24px] py-[12px] rounded-full'><img className='w-4 sm:w-6 mb-1 xl:mb-0 xl:w-8xl:mr-4' src={aboutIcon}></img><span className='text-sm xl:text-xl'>About</span></a>
